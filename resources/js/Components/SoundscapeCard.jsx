...
export default function SoundscapeCard({ soundscape }) {
    return (
        <Link
            href={`/s/${soundscape.slug}`}
            className="bg-bg-secondary rounded-2xl p-6 border border-border-subtle transition-all duration-250 hover:border-border-default hover:glow-teal block"
        >
